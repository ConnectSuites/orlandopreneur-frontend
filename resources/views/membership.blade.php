...
<div class="w-full h-full bg-cover bg-center bg-no-repeat"  style="background-image: url('{{ asset('storage/images/home/background.png') }}');">
  ...
  >
   ...
   <div class="flex flex-col max-w-6xl items-center justify-center mx-auto">
    ...
    />
      ...
      <div class="max-w-6xl mx-auto mb-8 flex flex-col bg-indigo-950/40 rounded-2xl border border-white/60 px-10 py-10 items-center justify-center">
            <div class="flex items-center justify-center">
                    <p class=" h-20 text-cyan-300 text-4xl font-bold font-['Montserrat'] leading-9">Membership Options</p>
            </div>
            <div class="grid grid-cols-2 gap-4">
                <div class=" h-96 px-8 py-8 relative bg-white rounded-2xl outline outline-1 outline-offset-[-1px] outline-yellow-400/10 backdrop-blur-[5px]">
